...
const Game: React.FC = () => {
  ...
  const gameLoop = useCallback(
    (currentTime: number) => {
      ...
      // Spawn bullets
      if (currentTime - lastBulletTime.current > BULLET_SPAWN_RATE) {
        setBullets((prev) => [
          ...prev,
          {
            id: currentTime,
      ...
      // Spawn meteors
      if (currentTime - lastMeteorTime.current > METEOR_SPAWN_RATE) {
        setMeteors((prev) => [
          ...prev,
          {
            id: currentTime,
    ...
    <section id="game" className="game">
      <div className="game__container">
          ...
          {gameStarted && !gameOver && (
            <div className="game__play-area">
              ...
              <div className="game__controls-hint">
                Move mouse to navigate | Auto-fire active
              </div>
            </div>
          )}
        ...
        <div className="game__footer">
          ...
          <p>Mouse controls + Auto-fire | High scores saved locally</p>
        </div>
      </div>
    </section>
  );
